...
class Game:
    ...
    def WaitScore(self):
        if((self.save3==0)and(self.gs==False)):
            self.save3=1
            self.root.after(20,self.GetScore)
        elif(self.save3==1):
            pass
        else:
            self.root.after(20,self.WaitScore)
...
button6=ctk.CTkButton(fenster, text="NextDart",command=Spiel.WS, font=("Arial",36), height=100, width=200)
button6.place(x=700,y=425)
